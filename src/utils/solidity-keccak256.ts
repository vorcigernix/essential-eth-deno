...
import { hexFalse } from '../classes/utils/encode-decode-transaction.ts';
import { logger } from '../logger/logger.ts';
import { tinyBig } from '../shared/tiny-big/tiny-big.ts';
import { arrayify, concat, hexlify, zeroPad } from './bytes.ts';
...
export async function solidityKeccak256(
  ...
  return await keccak256(pack(types, values));
}
