import type { JsonRpcProvider } from '../providers/JsonRpcProvider.ts';
import type { ContractInterface } from '../types/Contract.types.ts';
import {
  decodeRPCResponse,
  encodeData,
} from './utils/encode-decode-transaction.ts';
import { buildRPCPostBody, post } from './utils/fetchers.ts';
/**
 *
 * @param txnData
 * @example
