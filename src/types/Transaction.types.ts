...
export interface TransactionRequest {
	to?: string;
	from?: string;
	nonce?: TinyBig | string | typeof Big | number;
	gas?: TinyBig | number | typeof Big | string;
	gasPrice?: TinyBig | typeof Big | string | number;
	data?: BytesLike;
	value?: TinyBig | string | typeof Big | number;
	chainId?: number;
	type?: number;
	maxPriorityFeePerGas?: TinyBig | string | typeof Big | number;
	maxFeePerGas?: TinyBig | string | typeof Big | number;
}
